...
import com.example.dream_shop_server.exceptions.ProductNotFoundException;
...
import com.example.dream_shop_server.repository.ProductRepository;
...
public class ProductService implements IProductService {
    ...
    public Product updateProductById(ProductUpdateRequest request, Long productId) {
        return  productRepository.findById(productId)
                ...
                .orElseThrow(() -> new ProductNotFoundException("Product not found! updateProductById"));
    }
    ...
    public Product getProductById(Long productId) {
        return productRepository.findById(productId).orElseThrow(() ->
                new ProductNotFoundException("Product not found! getProductById"));
    }
    ...
    public void deleteProductById(Long productId) {
        productRepository.findById(productId).ifPresentOrElse(productRepository::delete,
                () -> {
                    throw new ProductNotFoundException("Product not found! deleteProductById");});
    }
